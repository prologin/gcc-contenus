...
Ecrire la fonction `is_in_matrix(P, val)` qui renvoie `True` si la valeur 'val'
est présente dans la matrice, `False` sinon.
"""


def is_in_matrix(P, val):
    pass
...
Ecrire la fonction `search_matrix(P, val)` qui renvoie une liste contenant deux
éléments, l'indice de la ligne et l'indice de la colonne sur lesquelles se
trouve la valeur recherchée 'val'.
"""


def search_matrix(P, val):
    pass
...
Ecrire la fonction `search_all(P, val)` qui renvoie une liste contenant tous
les duos de coordonnées sur lesquelles on peut trouver la valeur recherchée
'val'.
"""


def search_all(P, val):
    pass
...
Ecrire la fonction `set_matrix(lines, cols, val)` qui crée une matrice
...
dimensions.  Si les dimensions sont invalides, votre fonction doit renvoyer la
valeur `None`, au lieu de renvoyer la matrice nouvellement créée.
"""
