...
\vbox{
Vous trouverez à peu près les mêmes sprites pour les personnages suivant~:
\begin{center}
\begin{tabular}{c c c}
	\includegraphics[width=3em]{sprites/anime/p2/standing/frame-1.png} & \includegraphics[width=3em]{sprites/anime/p3/standing/frame-1.png} & \includegraphics[width=3em]{sprites/anime/p4/standing/frame-1.png} \\
	\texttt{\footnotesize p2/standing/frame-1.png} & \texttt{\footnotesize p3/standing/frame-1.png} & \texttt{\footnotesize p4/standing/frame-1.png} \\
	\texttt{\footnotesize p2/standing/frame-2.png} & \texttt{\footnotesize p3/standing/frame-2.png} & \texttt{\footnotesize p4/standing/frame-2.png} \\
	\texttt{\footnotesize p2/running/frame-1.png}  & \texttt{\footnotesize p3/running/frame-1.png} & \texttt{\footnotesize p4/running/frame-1.png} \\
	\texttt{\footnotesize p2/running/frame-2.png}  & \texttt{\footnotesize p3/running/frame-2.png} & \texttt{\footnotesize p4/running/frame-2.png} \\
	\texttt{\footnotesize p2/running/frame-3.png}  & \texttt{\footnotesize p3/running/frame-3.png} & \texttt{\footnotesize p4/running/frame-3.png} \\
	\texttt{\footnotesize p2/running/frame-4.png}  & \texttt{\footnotesize p3/running/frame-4.png} & \texttt{\footnotesize p4/running/frame-4.png} \\
	\texttt{\footnotesize p2/running/frame-5.png}  & \texttt{\footnotesize p3/running/frame-5.png} & \texttt{\footnotesize p4/running/frame-5.png} \\
	\texttt{\footnotesize p2/running/frame-6.png}  & \texttt{\footnotesize p3/running/frame-6.png} & \texttt{\footnotesize p4/running/frame-6.png} \\
	\texttt{\footnotesize p2/jump/jump\_up.png}    & \texttt{\footnotesize p3/jump/jump\_up.png} & \texttt{\footnotesize p4/jump/jump\_up.png} \\
	\texttt{\footnotesize p2/jump/jump\_fall.png}  & \texttt{\footnotesize p3/jump/jump\_fall.png} & \texttt{\footnotesize p4/jump/jump\_fall.png} \\
                                                   & \texttt{\footnotesize p3/got\_hit/frame.png} & \texttt{\footnotesize p4/got\_hit/frame.png} \\
\end{tabular}
\end{center}
}
