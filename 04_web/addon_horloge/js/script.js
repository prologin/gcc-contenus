...
function init() {
	// on ajoute notre HTML et CSS à la page
	...
	// Gestion du déplacement de notre popup
	popup.addEventListener("mousedown", e => popup.classList.add("drag"));
	// on écoute le relachement de la souris sur le document car il est
	// possible de bouger trop vite et que mouseup soit détecté en dehors
	// du popup
	...
	// Gestion du dessin de l'horloge
